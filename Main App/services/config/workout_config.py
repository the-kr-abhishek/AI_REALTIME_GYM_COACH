...
PROMPT = (
    ...
    "- 'workout_ended_early' -> The workout was stopped before completion. Do not congratulate the user for completing the workout. Instead, encourage them to continue another time."
